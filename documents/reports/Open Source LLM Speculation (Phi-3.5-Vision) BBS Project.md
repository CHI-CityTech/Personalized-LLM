...
[**4\. Evaluation of Model Prototypes	4**](#4.-evaluation-of-model-prototypes)

[4.1. phi-3.5-vision-instruct — “instruction-tuned default”	4](#4.1.-phi-3.5-vision-instruct-—-“instruction-tuned-default”)

[4.2. phi-3.5-vision-instruct (quantized 8-/4-bit) — “memory-saver”	5](#4.2.-phi-3.5-vision-instruct-\(quantized-8-/4-bit\)-—-“memory-saver”)

[4.3. phi-3.5-vision-instruct-onnx — “deployment-optimized”	5](#4.3.-phi-3.5-vision-instruct-onnx-—-“deployment-optimized”)

[4.4. Shared traits (all three)	5](#4.4.-shared-traits-\(all-three\))

[4.4.1. Quick pick guide	5](#4.4.1.-quick-pick-guide)

[**5\. Version History	6**](#5.-version-history)
...
Phi-3.5-Vision-Instruct is an open-weight vision-language model that looks at images and text together and replies in plain text. It’s compact (≈4.2B parameters), supports a long 128K-token context window, and is built to handle everyday multimodal tasks like visual question answering, reading text in images (OCR), chart/table understanding, and general visual reasoning. 
...
# **4\. Evaluation of Model Prototypes** {#4.-evaluation-of-model-prototypes}
...
## **4.1. phi-3.5-vision-instruct — “instruction-tuned default”** {#4.1.-phi-3.5-vision-instruct-—-“instruction-tuned-default”}
...
**Prompting tip:** Specify format/length (Example: “JSON with {character, prop, scene}; ≤2 sentences”).  
**Choose this if:** You want strong results now with minimal setup.

## **4.2. phi-3.5-vision-instruct (quantized 8-/4-bit) — “memory-saver”** {#4.2.-phi-3.5-vision-instruct-(quantized-8-/4-bit)-—-“memory-saver”}

**What it is:** The same checkpoint runs with integer quantization to cut VRAM and cost.  
**Best for:** Edge or budget GPUs/CPUs; batching for higher throughput under tight memory. **Pros:** Much lower memory use; often similar accuracy for tagging/captioning.  
...
## **4.3. phi-3.5-vision-instruct-onnx — “deployment-optimized”** {#4.3.-phi-3.5-vision-instruct-onnx-—-“deployment-optimized”}
...
## **4.4. Shared traits (all three)** {#4.4.-shared-traits-(all-three)}
...
### **4.4.1. Quick pick guide** {#4.4.1.-quick-pick-guide}
